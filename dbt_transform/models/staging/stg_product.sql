...
select
    cast(trim(product_id) as int64) as product_id,
    cast(trim(name) as string) as product_name,
    cast(trim(sku) as string) as product_sku,
    cast(trim(attribute_set_id) as int64) as attribute_set_id,
    ...
    cast(nullif(trim(collection_id), '') as int64) as collection_id,
    cast(nullif(trim(collection), '') as string) as collection_name,
    cast(nullif(trim(product_type_value), '') as int64) as product_type_id,
    cast(nullif(trim(product_type), '') as string) as product_type_name,
    cast(nullif(trim(category), '') as int64) as category_id,
